...
using WebApp.ChainOfResponsibilityPattern.ChainOfResponsibility;
...
namespace AspNetCoreDesignPatterns.BaseProject.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> SendEmail()
        {
            ...
            var sendEmailProcessHandler = new SendEmailProcessHandler("product.zip", "deneme@mertguney.com");
