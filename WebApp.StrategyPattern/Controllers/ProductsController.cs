...
namespace WebApp.StrategyPattern.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Stock,Price,CreatedDate,UserId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Stock,Price,CreatedDate,UserId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
